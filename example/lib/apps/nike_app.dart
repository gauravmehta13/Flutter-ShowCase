...
class _MyHomePageState extends State<MyHomePage>
  ...
  late Animation<Offset> _cartOffsetAnimation;
  late Animation<double> _nikeLogoOffsetAnimation;
  late Animation<Offset> _productBackgroundOffsetAnimation;
  late Animation<Offset> _productOffsetAnimation;
          ...
          _alignment != null
              ? Transform(
                  transform: Matrix4.identity()
                    ...
                    ..scale(1 - (lerpDouble(0, -0.25, _index - _page) ?? 0))
